...
|------------|----------------|------------------|--------------|--------------------|-----------------|----------------|-----------|----------|
| D-001 | 12-11-2025 | AUTH-TC-001: User Login/Registration - Password Storage | (Security) Verify passwords are stored in plain text. | 1. Log in with user@clean\t 001: AUTH-TC-001: User Login/Registration - Password Storage](/tests/screenshots/D-001.png) | High | Fail |
