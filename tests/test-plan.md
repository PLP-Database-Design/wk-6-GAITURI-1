...
| **Risk Analyst**  | Mark Mwangi | Identifies potential risks, assesses impact and likelihood, and develops mitigation strategies |
| **Test Executor** | Ian Macharia | Executes test cases, documents results, and reports defects in issue tracking tools.                          |
